#Do the same thing as Draculasent but use the lexicon afinn instead of bing
#to assign a positive or negative sentiment score to each word
...
#Get rid of the gutenberg_id column so we just have line id and text columns showing
